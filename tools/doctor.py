#!/usr/bin/env python3
"""Read-only CardBridge environment diagnostics.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Check CardBridge build prerequisites")
    ...
    try:
        ...
        add(checks, "repository", "ok", f"CardBridge {release} at {ROOT}")
